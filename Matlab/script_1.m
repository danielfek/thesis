...
etta   = 0                      % survival shock --- etta = unifrnd(0,1,I,1)
betta   = 97/100;                % subjective discount factor
deltta  = 5/100;                 % depreciation rate of physical capital
...
C0 = @(cp0,r) invup(betta*(1+r)*up(cp0)*pi');
...
tic;
myfun   = @(r) stationary_eq(r,crit,I,T,Amat,Ymat,alpha,b,deltta,rho,varphi,A0,C0,H);
...
[r,at] = stationary_eq(rstar,crit,I,T,Amat,Ymat,alpha,b,deltta,rho,varphi,A0,C0,H);
